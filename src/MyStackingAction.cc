...
MyStackingAction::ClassifyNewTrack(const G4Track* track)
{
  ...
  if ((track->GetDefinition() == G4Electron::Electron()) || (track->GetDefinition() == G4Positron::Positron())) return fWaiting;
  ...
  if ((track->GetDefinition() == G4Gamma::Gamma()) && (particleEnergy < 9.5 * MeV )) return fWaiting;
