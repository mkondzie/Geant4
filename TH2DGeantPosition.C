...
leg->AddEntry((TObject*)0, Form("#mu_{x} = %.0f mm, #sigma_{x} = %.0f mm", meanX, stdDevX), "");
leg->AddEntry((TObject*)0, Form("#mu_{y} = %.0f mm #sigma_{y} = %.0f mm", meanY, stdDevY), "");
